...
return 
    ...
    if(password.length < 8){
      setAlerta({msg: 'El password es muy corto, agrega otro', error:true})
  ...
  const {msg} = alerta
    return (
      ...
      <>
        <div>
            <h1 className="text-indigo-600 font-black text-6xl">Crea tu cuenta y {""} <span className="text-black"> Administra pacientes</span></h1>
        </div>
